// ==UserScript==
// @name         Empornium Preview Thumbnail
// @namespace    https://github.com/unt0uchable/userscripts
...
// @author       unt0uchable
// @version      0.99
// @downloadURL  https://github.com/unt0uchable/userscripts/raw/master/empornium.me/empornium-preview-th.user.js
// @updateURL    https://github.com/unt0uchable/userscripts/raw/master/empornium.me/empornium-preview-th.user.js
...
(function() {
    ...
    function mouseWheelListener(evt) {
        ...
        if (delta > 0 && picNo > 0)
            picNo--;
        if (delta < 0 && picNo+1 < cache[link]['images'].length)
            picNo++;
        loadPic();
...
'http://img4.imagetwist.com/th/01013/2p6yl2cimykc.jpg'*/
    ...
    function initListeners() {
        ...
        for (var i=0;i<trs.length;i++) {
            ...
            if (!trigger) continue;
            // trigger.addEventListener('onload', onLoadListener, false);
            ...
            // trigger.addEventListener("mousewheel", MouseWheelHandler, false);
            // Firefox
            // trigger.addEventListener("DOMMouseScroll", mouseWheelListener, false);
            // trigger.addEventListener("DOMMouseScroll", mouseScrollListener, false);
        ...
        document.addEventListener("DOMMouseScroll", mouseWheelListener, false);
        // document.addEventListener("DOMMouseScroll", mouseScrollListener, false);
        container.img.addEventListener('load', loadListener, false);
        // container.img.addEventListener('scroll', scrollListener, false);
        // container.img.addEventListener('wheel', wheelListener, false);
    }
